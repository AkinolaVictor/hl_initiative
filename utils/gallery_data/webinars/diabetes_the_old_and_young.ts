...
export const diabetes_the_old_and_young = {
    ...
    theme: "Why no age is exempted",
    venue: "Online",
    date: "",
    image: "diabetes.jpg",
    description: `
        A global digital session exploring the rising prevalence of diabetes across all generations, 
        debunking myths of age exemption, and promoting proactive management and prevention for 
        diverse populations.
    `,
    introduction: [
    ...
    impact: [
        ...
        `Feedback indicated more than 70% increase in participant confidence regarding symptom recognition. By connecting global experts with a wide-reaching audience, the webinar fostered a supportive digital community dedicated to proactive health, proving that education is our strongest tool against the diabetes epidemic.`
    ],
    assets: [
        {
            name: "diabetes.jpg",
...
// We carried out a webinar session on the theme Diabetes: the old and young (why no age is exempted)
