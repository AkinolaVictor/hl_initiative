...
export const rethink_obesity = {
    ...
    Content: ()=>{
        return  (
            <div>
                <p>Love yourself as you are” meets “watch your health” but do the two always agree?</p>

                <p className="mt-3">
                    Obesity is commonly defined as having too much body fat. A BMI of 30 or higher is the usual
                    benchmark for obesity in adults. Obesity increases the risk of serious medical conditions.
                    Treatments include changing what you eat, adding activity and mental health support.
                </p>

                <p className="mt-3">
                    Obesity is one of the fastest-growing health challenges in the world. According to the World
                    Health Organization, childhood obesity has quadrupled since 1990, and adults living with
                    obesity have more than doubled. Doctors warn us that excess weight raises the risk of heart
                    disease, diabetes, certain cancers and even mobility issues.
                </p>

                <p className="font-semibold my-5">The Rise of Body Positivity</p>
                <p>
                    The body positivity movement began as a way to fight discrimination and unfair beauty
                    standards. It has helped people who felt excluded to build confidence and has reduced some of
                    the shame linked with weight. On social media, the movement spread quickly, encouraging
                    self-love and representation for all body types. Many people say body positivity has improved
                    their mental health, self-esteem and sense of belonging.
                </p>
