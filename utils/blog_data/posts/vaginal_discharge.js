...
export const vaginal_discharge = {
    ...
    Content: ()=>{
        return <div>
            <p>
                Vaginal discharge is something many women experience, yet it is often misunderstood. Some
                women feel worried or embarrassed about it, but the truth is that vaginal discharge is often
                normal and healthy. This write up will help you understand what vaginal discharge is, when it is
                normal, and when you should see a health worker.
                <br />
                ...
                <br />
                Every woman’s body is different, and the amount of discharge can vary from person to person.
                It increases with increased estrogen states: pregnancy,oral contraceptive pills , mid-cycle,
                ...
                <br />
                <br />
                Vaginal discharge is not always a disease. Knowing what is normal helps you identify when
                something is wrong. There is no shame in seeking medical care. Early attention keeps you
                healthy and prevents serious problem
            </p>
        </div>
    }
}